...
**Desarrollador Web en formación | Especialista en Logística & Operaciones**
He pasado los últimos años optimizando flujos de trabajo en el sector logístico en Barcelona, y ahora estoy aplicando esa misma mentalidad de eficiencia y resolución de problemas al mundo del desarrollo de software. Mi transición no es solo un cambio de carrera, es la evolución natural de alguien que busca construir herramientas que hagan la vida más fácil a las empresas y a las personas.
